...
#   timestamp: 2026-02-11T05:48:55+00:00
...
class HealthResponse(BaseModel):
    status: Annotated[
        Status,
        Field(description='Health status (always "ok" if the control plane is running)'),
    ]
...
class InfoResponse(BaseModel):
    name: Annotated[
        str,
        Field(description="Connection name for this client", examples=["my-service-12345"]),
    ]
...
class WakeResponse(BaseModel):
    ...
    connection_id: Annotated[
        str,
        Field(description="Connection ID assigned by the daemon", examples=["conn_abc123"]),
    ]
