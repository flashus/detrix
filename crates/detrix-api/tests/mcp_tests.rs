...
async fn test_add_metric_with_memory_snapshot() {
    ...
    let metric = Metric {
        ...
        expression: "session.token".to_string(),
        language: SourceLanguage::Python,
        enabled: true,
...
async fn test_add_metric_with_time_based_sampling() {
    ...
    let metric = Metric {
        ...
        expression: "request.count".to_string(),
        language: SourceLanguage::Python,
        enabled: true,
...
async fn test_add_metric_with_all_features() {
    ...
    let metric = Metric {
        ...
        expression: "payment.amount".to_string(),
        language: SourceLanguage::Python,
        enabled: true,
...
async fn test_snapshot_scope_global() {
    ...
    let metric = Metric {
        ...
        expression: "__detrix_snapshot__(scope='global')".to_string(),
        language: SourceLanguage::Python,
        enabled: true,
        mode: MetricMode::First,
        condition: None,
