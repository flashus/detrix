...
fn test_rust_adapter_logpoint_message() {
    let metric = Metric {
        ...
        expressions: vec!["order.total".to_string()],
...
fn test_rust_complex_expression() {
    let metric = Metric {
        ...
        expressions: vec!["items.len()".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
...
fn test_rust_option_expression() {
    let metric = Metric {
        ...
        expressions: vec!["value.unwrap_or_default()".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
...
fn test_rust_iterator_expression() {
    let metric = Metric {
        ...
        expressions: vec!["values.iter().sum::<i32>()".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
...
fn test_rust_str_expression() {
    let metric = Metric {
        ...
        expressions: vec!["name.as_str()".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
...
fn test_rust_tuple_expression() {
    let metric = Metric {
        ...
        expressions: vec!["pair.0".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
...
fn test_rust_array_expression() {
    let metric = Metric {
        ...
        expressions: vec!["items[2]".to_string()],
        language: detrix_core::SourceLanguage::Rust,
        enabled: true,
        mode: MetricMode::Stream,
        condition: None,
