...
async fn test_e2e_multiple_connections() {
    ...
    let identity1 =
        detrix_core::ConnectionIdentity::new("conn-1", "python", "/test-workspace", "test-host");
    let conn1 = fixture
        .connection_service
        .create_connection(
            "localhost".to_string(),
    ...
    let identity2 =
        detrix_core::ConnectionIdentity::new("conn-2", "python", "/test-workspace", "test-host");
    let conn2 = fixture
        .connection_service
        .create_connection(
            "localhost".to_string(),
    ...
    let identity3 =
        detrix_core::ConnectionIdentity::new("conn-3", "python", "/test-workspace", "test-host");
    let conn3 = fixture
        .connection_service
        .create_connection(
            "localhost".to_string(),
...
async fn test_e2e_connection_status_updated_on_crash() {
    ...
    let identity_python = detrix_core::ConnectionIdentity::new(
        "python-conn",
        "python",
        "/test-workspace",
        "test-host",
    ...
    let identity_rust =
        detrix_core::ConnectionIdentity::new("rust-conn", "rust", "/test-workspace", "test-host");
